...
class AppsView {
    ...
    focusFirstItem() {
        ...
        if (buttons.length > 0 && buttons[0]) {
            // Highlight first result for Enter-to-launch WITHOUT stealing
            // keyboard focus from the search entry (so typing continues).
            try { buttons[0].handleEnter(); } catch(e) {}
            try { buttons[0].has_focus = true; } catch(e) {}
        }
    }
